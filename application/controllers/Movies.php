...
class Movies extends MY_Controller {
    ...
    public function type($slug = NULL) {
        ...
        if ($slug == 'films') {
            ...
            $this->data['movie_data'] = $this->Films_model->getMovieOnPage($row_count, $offset, 1);
        }
    ...
    public function create() {
        ...
        if($this->input->post('slug') && $this->input->post('name') && $this->post('descriptions') && $this->input->post('year') && $this->input->post('rating') && $this->input->post('poster') && $this->input->post('player_code') && $this->input->post('director') && $this->input->post('add_date') && $this->input->post('category_id')) {
             
            $slug = $this->input->post('slug');
            $name = $this->$this->post('name');
            ...
            if($this->Films_model->setMovies($slug, $name, $description, $year, $rating, $poster, $player_code, $director, $add_date, $category_id)) {
